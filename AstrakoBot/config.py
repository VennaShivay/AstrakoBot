...
class Config(object):
    ...
    TOKEN = "5851046922:AAFou7rVOme49kydX-9qEZxv7yu1tkmWMbo"  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    SUPPORT_CHAT = "ValorantAstraSupport"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001802428799
